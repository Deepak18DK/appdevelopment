    ...
    <div class ="whole">
      ...
      <form onSubmit={handleSubmit1}>
         <div class="form-row">
               ...
               <div class="mb-3">
                <label for="expAmount" class="form-label">Expense</label>
                <input type="number" class="form-control" id="expAmount" onChange={handleChange1}/>
                </div>

                <div class="mb-3">
                <label for="category" class="form-label">Category</label><br/>
                <select class="form-select" aria-label="Default select example" onChange={handleChange1} id="category">
